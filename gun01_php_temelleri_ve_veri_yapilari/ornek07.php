...
echo $a * 2;
echo "<br>";
$a_string = (string) $a; // a'yı string'e dönüştür // "2025"
echo $a_string ." yılı" ; // . ile string ifadeler birleşir string olmayanlar ise stringe dönüşür
echo $a_string[0]; // İlk karakteri yazdırır: 2

var_dump($a_string); // Değişkenin tipini ve değerini ayrıntılı olarak gösterir
...
$sayi_metin = "2 Temmuz";
$sayi = (int) $sayi_metin; // String'den Integer'a dönüşüm
echo $sayi. "<br>"; // 2 olarak yazdırır, çünkü baştaki sayıyı alır

$sayi_metin = "Temmuz 2";
$sayi = (int) $sayi_metin; // String'den Integer'a dönüşüm
echo $sayi. "<br>"; // 0 olarak yazdırır, çünkü baştaki harfler sayıya dönüşmez

$sayi_metin = "Temmuz 2";
$sayi = (int) $sayi_metin[7]; // String'den Integer'a dönüşüm ve 7. indeksteki karakteri alır
echo $sayi. "<br>"; // 2 olarak yazdırır, çünkü 7. indeksteki karakter '2'dir
